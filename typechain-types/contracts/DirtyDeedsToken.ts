...
export interface DirtyDeedsTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "CLOCK_MODE"
      | "DOMAIN_SEPARATOR"
...
export interface DirtyDeedsToken extends BaseContract {
  connect(runner?: ContractRunner | null): DirtyDeedsToken;
  waitForDeployment(): Promise<this>;

  interface: DirtyDeedsTokenInterface;
